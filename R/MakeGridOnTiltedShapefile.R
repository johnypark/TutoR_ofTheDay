...
MakeGridAffine<-function(SfObjectRect,SfOrigRect,CellSize){
...
BCI50ha_grid<-MakeGridAffine(SfObjectRect = sf_bci50ha,
...
grid_orig<-Bci50haExtent_orig%>%st_make_grid(cellsize=50)%>%st_sf(grid_id=c(1:length(.)))
